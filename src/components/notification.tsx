import { removeNotif } from "~/store/signaux"
...
export default function Notification(props: any){
    ...
    return<>
        <div id={"alert" + props.notif.id } class="z-[1056] absolute sm:container mx-auto flex p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" >
